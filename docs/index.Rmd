...
- **Grupo de WhatsApp:** 
[_INGRESSE NO GRUPO CLICANDO AQUI_](https://chat.whatsapp.com/GFFjHxSqhHFIjl2Vj96PQr)
...
- **ATENDIMENTO PREVIAMENTE AGENDADO**:
    ...
    - [**https://valerio-victor.github.io/agenda**](https://valerio-victor.github.io/agenda)
...
[**link**](https://chat.whatsapp.com/GFFjHxSqhHFIjl2Vj96PQr)! Obviamente, sua entrada é facultativa!
...
cronograma <- data.frame(
  SEMANA = c(9, 10, 11, 12, 13, 14, 15, 16),
  ...
  TEMAS = c('Identidades Macroeconômicas',
            ...
            'Otimização da Produção no Curto Prazo',
            'Otimização da Produção no Longo Prazo', 
